export type VerbPack = {
  ...
  description: string;
  verbIds: string[];
  /** Must have this many verbs from prerequisite pack at rep ≥ 1 ("learned") to unlock */
  unlocksAfter?: { packId: string; minLearned: number };
};
...
export const VERB_PACKS: VerbPack[] = [
  ...
  },
  {
    ...
    unlocksAfter: { packId: 'pack-1', minLearned: 5 },
  },
  {
    id: 'pack-3',
    name: 'Actions & Study',
    ...
    unlocksAfter: { packId: 'pack-2', minLearned: 8 },
  },
  {
    id: 'pack-4',
    name: 'N5 Complete',
    ...
    unlocksAfter: { packId: 'pack-3', minLearned: 8 },
  },
  {
    id: 'pack-5',
    name: 'N4 Essentials',
    ...
    unlocksAfter: { packId: 'pack-4', minLearned: 8 },
  },
  {
    id: 'pack-6',
    name: 'N4 Advanced',
    ...
    unlocksAfter: { packId: 'pack-5', minLearned: 8 },
  },
];
